            ...
            <footer className="PageFooter">
                ...
                <section> 
                    <a href="mailto:johnathanlee72@hotmail.com">
                        <img class="content-info email" src={mailIcon} alt="JYL email"/>
                    </a>
                    <a href="https://linkedin.com" target="_blank">
                        <img class="content-info linkedin" src={linkedIcon} alt="JYL linkedin"/>
                    </a>
                    <a href="https://github.com/johlee92" target="_blank">
                        <img class="content-info github" src={githubIcon} alt="JYL GitHub"/>
                    </a>                  
                </section>
            </footer>
        )
